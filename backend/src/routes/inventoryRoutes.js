...
import { getInventoryItems, getMyInventoryItems, getInventoryItemById, createInventoryItem, updateInventoryItem, deleteInventoryItem, getExpiringItems, getMyExpiringItems, getInventoryAnalytics, getItemsByLocation, addManualInventoryItem, } from "../controllers/inventoryController.js";
const router = Router();
