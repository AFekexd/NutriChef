...
import { register, registerValidation, login, loginValidation, logout, refreshToken, getProfile, getSessions, revokeSession, getLoginHistory, updateProfile, changePassword, } from "../controllers/authController.js";
